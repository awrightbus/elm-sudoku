...
var $author$project$Sudoku$showRow = function (cs) {
	return A2(
		$elm$html$Html$tr,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$map,
			function (c) {
				return $author$project$Sudoku$showCell(c);
			},
			cs));
};
var $elm$html$Html$table = _VirtualDom_node('table');
var $author$project$Sudoku$showBoard = function (b) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					function (r) {
						return $author$project$Sudoku$showRow(r);
					},
					$author$project$Sudoku$rows(b)))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Elm Sudoku Solver')
					])),
				$author$project$Sudoku$showBoard(model.sboard),
				A2(
...
var $author$project$Sudoku$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Sudoku$init, update: $author$project$Sudoku$update, view: $author$project$Sudoku$view});
